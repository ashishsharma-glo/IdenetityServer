...
namespace WebApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> 
            VerifyCode(string provider, string returnUrl, bool rememberMe)
        {
        ...
        [AllowAnonymous]
        public async Task<ActionResult> VerifyOneTouch
        ...
        [ValidateAntiForgeryToken]
        public async Task<ActionResult>
            VerifyCode(VerifyCodeViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            ...
            var result = await SignInManager.
                TwoFactorSignInAsync(model.Provider,
        ...
        public async Task<ActionResult> VerifyOneTouch(VerifyOneTouchViewModel model)
        {
            var result = await SignInManager.TwoFactorSignInAsync(
                model.Provider, string.Empty, model.RememberMe, 
